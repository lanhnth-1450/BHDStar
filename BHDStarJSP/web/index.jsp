            ...
            <div class="index">
                <div class="section--product-view">
                            ...
                            <div class="scroll-wrapper js_film">
                                <div class="flex-viewport" style="overflow: hidden;position: relative;">
                                    <ul class="slides">
                                        ...
                                        <li class="type-movies" style="width: 200px; margin-right: 23px; float: left; display: block;">
                                            <div class="film-item">
                                                <a class="bhd-trailer-box bhd-trailer" href="slidevideo.html">Trailer</a>
                                                <span class="meta-box-type">
                                                    <span class="film--rating">C 18</span>
                                                    <span class="tech--2d">2D</span>
                                                </span>
                                        ...
                                        <li class="type-movies" style="width: 200px; margin-right: 23px; float: left; display: block;"> 
                                            <div class="film-item">
                                                <a class="bhd-trailer-box bhd-trailer" href="#">Trailer</a>
                                                <span class="meta-box-type">
                                                    <span class="film--rating">C 18</span>
                                                    <span class="tech--2d">2D</span>
                                                </span>
                    ...
                    <script type="text/javascript">
                        function videoFuntion() {

                            var videoFrm = document.getElementsByClassName("html5-video-container");
                            videoFrm.style.display = "block";
                            alert("lanh");
                        }
                    </script>
                    <iframe class="html5-video-container" src="slidevideo.html" height="100%" width="	100%" style="display: none; z-index: 9999999999;"></iframe> 
                </div>
