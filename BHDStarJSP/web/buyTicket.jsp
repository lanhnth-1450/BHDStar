<%-- 
    Document   : buyTicket
    Created on : Dec 24, 2017, 11:12:41 PM
    Author     : Lanh
--%>
...
<html>
    ...
    <body>
        ...
        <jsp:include page="view_component/header.jsp"></jsp:include>
            <div id="wrapper" style="background: #fff1ce;">  
                <div class="container">
                    <div class="row">
                        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                            ...
                            <div class="row">
                                ...
                                <button id="pay" type="button" class="btn btn-success btn-lg btn-block">
            ...
            <script type="text/javascript">
                jQuery(document).ready(function ($) {
                    $("button.btn-block").click(function (event) {
                        $("#in--pay").wordExport();
                    });
                });
            </script>
