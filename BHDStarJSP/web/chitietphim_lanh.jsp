<%-- 
    Document   : chitietphim_lanh
    Created on : Dec 23, 2017, 5:51:09 PM
    Author     : Lanh
--%>
                            ...
                            <div class="film--detail-content-top">
                                <div class="row">
                                    <div class="col-thubnail-bhd col-md-5" style="margin-left: 40px;">
                                        <a href="#"><img src="images/films/BHD-Star-Kingsman-poster-470x700-245x365.jpg" sizes="(max-width: 470px) 100vw, 470px" width="300" height="420"></a>
                                    </div>
                                    <div class="product--view col-md-7">
                                        ...
                                        <div class="film--detail">
                                            <p>Bộ phim dựa trên câu chuyện có thật về hành trình ngoạn mục đưa vụ Watergate (Vụ bê bối chính trị lớn nhất trong lịch sử Mỹ) ra ánh sáng của hai phóng viên Bob Woodward và Carl Bernstein, cùng vai trò sống còn của đặc vụ FBI, Mark Felt – mật danh Deep Throat…</p>
                                        </div>
                                        <span>
                                            <ul class="film--info" >
                                                <li class="films--li">
                                                ...
                                                <li class="films--li">
                                                    ...
                                                    <span class="col-right">2017/11/17</span>
                                                </li>
                                                <li class="films--li">
                                                    <span class="col-left">Thời lượng</span>
                                                    <span class="col-right">103 phút</span>
                                                </li>
                                                <li class="films--li">
